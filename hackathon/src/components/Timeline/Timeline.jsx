...
const timelineData = [
  ...
  { date: 'Sept 25, 2025', title: 'Registration Closes', desc: 'No new entries after this date.' },
  { date: 'Sept 26, 2026 9.30 AM', title: 'Kickoff & Opening Ceremony', desc: 'Welcome note + Seat allocation' },
